...
if __name__ == '__main__':
    ...
    parser.add_argument('--rho', default=0.5, type=float, help='Initial rho')
    parser.add_argument('--bata', default=40, type=float, help='weight loss_recon')
    parser.add_argument('--theta', default=1.3, type=float, help='weight loss_c2')
    parser.add_argument('--gama', default=0.01, type=float, help='weight loss_g')
